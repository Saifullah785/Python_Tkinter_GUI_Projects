...
from employee_form_window import connect_database

# creating function for delete supplier button 
...
def delete_supplier(invoice,treeview):
    ...
    # creating function for clearing the record 
def clear(invoice_entry,name_entry,contact_entry,description_text,treeview):
    ...
    #creating function for search supplier detail
def search_supplier(search_value,treeview):
    ...
    # creating function for showing all the record on treeview section
def show_all(treeview,search_entry):
     treeview_data(treeview)
     search_entry.delete(0,END)

          
    # creating function for update supplier detail 
def update_supplier(invoice,name,contact, description,treeview):
    ...
    # creating function for select detail from treeview section 
...
def treeview_data(treeview):
    ...
    # creating function for add new supplier detail in database
def  add_supplier(invoice,name,contact, description,treeview):
    ...
    #  creating supplier form window in the form function or using function
def supplier_form(window):
    ...
    heading_Label=Label(supplier_frame,text='Manage Supplier Detail',font=('times new roman',16,'bold'),bg='#0f4d7d',fg='white')
    heading_Label.place(x=0,y=0,relwidth=1)

    back_image = PhotoImage(file='E:/python projects/inventory management system/images/backbutton.png')
    back_button=Button(supplier_frame,image=back_image,bd=0,cursor='hand2',command=lambda:supplier_frame.place_forget())
    back_button.place(x=10,y=30)

    # creating left frame on supplier window
    ...
    #creating frame for bottom button on supplier form
    ...
    add_button =Button(button_frame,text='Add',font=("times new roman",14),width=8,cursor='hand2',
                          fg='white',bg='#0f4d7d',command=lambda :add_supplier(invoice_entry.get(),name_entry.get(),contact_entry.get(),
    ...
    update_button =Button(button_frame,text='Update',font=("times new roman",14),width=8,cursor='hand2',
                          fg='white',bg='#0f4d7d',command=lambda :update_supplier(invoice_entry.get(),name_entry.get(),contact_entry.get(),
                                                                               description_text.get(1.0,END).strip(),treeview))
    ...
    #creating right frame on supplier window
