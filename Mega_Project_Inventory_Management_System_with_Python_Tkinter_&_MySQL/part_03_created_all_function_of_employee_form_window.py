...
def connect_database():
    ...
    try:
       ...
       cursor = connection.cursor()
        ...
        messagebox.showerror('Error',"Datebase connectivity issue try again, open mysql command line client")
        return None,None

    return cursor,connection

def create_datebase_table():
...
# treeview for seeing all the employee data
def treeview_data():
    cursor,connection = connect_database()
...
def add_employee(empid, name, email, gender, dob, contact,employment_type, education, work_shift,
...
def clear_fields(empid_entry,name_entry,email_entry,
    ...
    education_combobox.set('Select Eduction')
...
def update_employee(empid, name, email, gender, dob, contact,employment_type, education, work_shift,
                 address, doj, salary, user_type, password):
