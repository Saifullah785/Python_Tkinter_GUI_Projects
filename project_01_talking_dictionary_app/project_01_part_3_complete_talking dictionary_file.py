...
searchButton = Button(root, image=searchButton_image,bd=0,bg='whitesmoke',cursor="hand2",activebackground="whitesmoke",command=search)
...
micButton = Button(root, image=micButton_image,bd=0,bg='whitesmoke',cursor="hand2",activebackground="whitesmoke",command=wordaudio)
...
audio_Button = Button(root, image=audio_image,bd=0,bg='whitesmoke',cursor="hand2",activebackground="whitesmoke",command=meaningaudio)
...
clear_Button = Button(root, image=clear_image,bd=0,bg='whitesmoke',cursor="hand2",activebackground="whitesmoke",command=clear)
...
exit_Button = Button(root, image=exit_image,bd=0,bg='whitesmoke',cursor="hand2",activebackground="whitesmoke",command=iexit)
